...
function changeForm(block: { value: any; childrens: any; }, index: any) {
  useChangeValue(block,block.value);
...
<template>
  <div :class="{ 'form-hide need-toggle-hide': block.hide }">
    ...
    >
      <input
        :type="block.type"
        class="w-full border-solid border-[1px] border-cyan-500 rounded p-2 px-3 focus:outline-none focus:shadow-no-offset focus:shadow-cyan-500/50"
        v-model="block.value"
